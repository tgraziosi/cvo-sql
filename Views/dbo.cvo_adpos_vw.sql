...
CREATE view [dbo].[cvo_adpos_vw] as
select   
...
GO
GRANT REFERENCES ON  [dbo].[cvo_adpos_vw] TO [public]
GO
GRANT SELECT ON  [dbo].[cvo_adpos_vw] TO [public]
GO
GRANT INSERT ON  [dbo].[cvo_adpos_vw] TO [public]
GO
GRANT DELETE ON  [dbo].[cvo_adpos_vw] TO [public]
GO
GRANT UPDATE ON  [dbo].[cvo_adpos_vw] TO [public]
GO
