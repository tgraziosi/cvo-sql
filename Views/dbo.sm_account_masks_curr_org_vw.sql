...
CREATE VIEW [dbo].[sm_account_masks_curr_org_vw] as 
...
AND h.global_flag = 1		
GO
GRANT REFERENCES ON  [dbo].[sm_account_masks_curr_org_vw] TO [public]
GO
GRANT SELECT ON  [dbo].[sm_account_masks_curr_org_vw] TO [public]
GO
GRANT INSERT ON  [dbo].[sm_account_masks_curr_org_vw] TO [public]
GO
GRANT DELETE ON  [dbo].[sm_account_masks_curr_org_vw] TO [public]
GO
GRANT UPDATE ON  [dbo].[sm_account_masks_curr_org_vw] TO [public]
GO
