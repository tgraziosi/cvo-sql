...
create view [dbo].[part_loc_price_vw] as
...
and pc.active_ind = 1
GO
GRANT REFERENCES ON  [dbo].[part_loc_price_vw] TO [public]
GO
GRANT SELECT ON  [dbo].[part_loc_price_vw] TO [public]
GO
GRANT INSERT ON  [dbo].[part_loc_price_vw] TO [public]
GO
GRANT DELETE ON  [dbo].[part_loc_price_vw] TO [public]
GO
GRANT UPDATE ON  [dbo].[part_loc_price_vw] TO [public]
GO
