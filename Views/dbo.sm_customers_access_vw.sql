...
CREATE VIEW [dbo].[sm_customers_access_vw]
AS
...
GO
GRANT SELECT ON  [dbo].[sm_customers_access_vw] TO [public]
GO
GRANT INSERT ON  [dbo].[sm_customers_access_vw] TO [public]
GO
GRANT DELETE ON  [dbo].[sm_customers_access_vw] TO [public]
GO
GRANT UPDATE ON  [dbo].[sm_customers_access_vw] TO [public]
GO
