...
CREATE VIEW [dbo].[adm_vend_all] AS
select
	a.timestamp,
	a.vendor_code,
...
GO
GRANT REFERENCES ON  [dbo].[adm_vend_all] TO [public]
GO
GRANT SELECT ON  [dbo].[adm_vend_all] TO [public]
GO
GRANT INSERT ON  [dbo].[adm_vend_all] TO [public]
GO
GRANT DELETE ON  [dbo].[adm_vend_all] TO [public]
GO
GRANT UPDATE ON  [dbo].[adm_vend_all] TO [public]
GO
