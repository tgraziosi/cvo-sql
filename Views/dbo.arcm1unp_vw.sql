...
CREATE view [dbo].[arcm1unp_vw]  as
select 
	t2.address_name,	 
	t2.customer_code,	
	t1.doc_ctrl_num, 	
  ...
  from 
	arinpchg t1, armaster t2, arcmtype t3
...
GO
GRANT REFERENCES ON  [dbo].[arcm1unp_vw] TO [public]
GO
GRANT SELECT ON  [dbo].[arcm1unp_vw] TO [public]
GO
GRANT INSERT ON  [dbo].[arcm1unp_vw] TO [public]
GO
GRANT DELETE ON  [dbo].[arcm1unp_vw] TO [public]
GO
GRANT UPDATE ON  [dbo].[arcm1unp_vw] TO [public]
GO
