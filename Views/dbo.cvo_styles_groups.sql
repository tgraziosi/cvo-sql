...
CREATE VIEW [dbo].[cvo_styles_groups]
AS
...
GO
GRANT SELECT ON  [dbo].[cvo_styles_groups] TO [public]
GO
GRANT INSERT ON  [dbo].[cvo_styles_groups] TO [public]
GO
GRANT DELETE ON  [dbo].[cvo_styles_groups] TO [public]
GO
GRANT UPDATE ON  [dbo].[cvo_styles_groups] TO [public]
GO
