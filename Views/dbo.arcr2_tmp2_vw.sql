...
create view [dbo].[arcr2_tmp2_vw] as
 select 
	t2.address_name,	
	t3.org_id, 
	t2.customer_code, 	
...
GO
GRANT REFERENCES ON  [dbo].[arcr2_tmp2_vw] TO [public]
GO
GRANT SELECT ON  [dbo].[arcr2_tmp2_vw] TO [public]
GO
GRANT INSERT ON  [dbo].[arcr2_tmp2_vw] TO [public]
GO
GRANT DELETE ON  [dbo].[arcr2_tmp2_vw] TO [public]
GO
GRANT UPDATE ON  [dbo].[arcr2_tmp2_vw] TO [public]
GO
