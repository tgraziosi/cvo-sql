...
GO
 CREATE VIEW [dbo].[artrx_alt_vw]
			AS
			  ...
			  FROM artrx_all 
GO
GRANT REFERENCES ON  [dbo].[artrx_alt_vw] TO [public]
GO
GRANT SELECT ON  [dbo].[artrx_alt_vw] TO [public]
GO
GRANT INSERT ON  [dbo].[artrx_alt_vw] TO [public]
GO
GRANT DELETE ON  [dbo].[artrx_alt_vw] TO [public]
GO
GRANT UPDATE ON  [dbo].[artrx_alt_vw] TO [public]
GO
