...
CREATE VIEW [dbo].[glchrPE_vw] AS
SELECT 
	case when o.org_id = ' ' then dbo.IBOrgbyAcct_fn (c.account_code)
...
FROM 
	...
	INNER JOIN InterBranchAcctsPE_vw o
		ON c.account_code = o.account_code
WHERE o.ib_flag <> 2
	
GO
GRANT REFERENCES ON  [dbo].[glchrPE_vw] TO [public]
GO
GRANT SELECT ON  [dbo].[glchrPE_vw] TO [public]
GO
GRANT INSERT ON  [dbo].[glchrPE_vw] TO [public]
GO
GRANT DELETE ON  [dbo].[glchrPE_vw] TO [public]
GO
GRANT UPDATE ON  [dbo].[glchrPE_vw] TO [public]
GO
