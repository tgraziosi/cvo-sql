...
WHERE  	th.trx_type 		= 120
  AND  	th.posting_flag 	= 0


GO
GRANT REFERENCES ON  [dbo].[amtrxrda_vw] TO [public]
GO
GRANT SELECT ON  [dbo].[amtrxrda_vw] TO [public]
GO
GRANT INSERT ON  [dbo].[amtrxrda_vw] TO [public]
GO
GRANT DELETE ON  [dbo].[amtrxrda_vw] TO [public]
GO
GRANT UPDATE ON  [dbo].[amtrxrda_vw] TO [public]
GO
