...
CREATE VIEW [dbo].[cvo_item_avail_r2_vw] AS
...
-- select top 100 * From cvo_item_avail_vw where location = '001' and future_ord_qty > 0
-- select top 100 * From cvo_item_avail_r2_vw where location = '001' 
SELECT         
...
GO
GRANT DELETE ON  [dbo].[cvo_item_avail_r2_vw] TO [public]
GO
GRANT INSERT ON  [dbo].[cvo_item_avail_r2_vw] TO [public]
GO
GRANT REFERENCES ON  [dbo].[cvo_item_avail_r2_vw] TO [public]
GO
GRANT SELECT ON  [dbo].[cvo_item_avail_r2_vw] TO [public]
GO
GRANT UPDATE ON  [dbo].[cvo_item_avail_r2_vw] TO [public]
GO
