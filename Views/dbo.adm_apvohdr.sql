...
CREATE VIEW [dbo].[adm_apvohdr]
	AS
	 ...
	 FROM apvohdr_all
GO
GRANT REFERENCES ON  [dbo].[adm_apvohdr] TO [public]
GO
GRANT SELECT ON  [dbo].[adm_apvohdr] TO [public]
GO
GRANT INSERT ON  [dbo].[adm_apvohdr] TO [public]
GO
GRANT DELETE ON  [dbo].[adm_apvohdr] TO [public]
GO
GRANT UPDATE ON  [dbo].[adm_apvohdr] TO [public]
GO
