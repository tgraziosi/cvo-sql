...
SET ANSI_NULLS OFF
GO
CREATE view [dbo].[adm_so_hdr_locs_access_vw]
AS
...
GO
GRANT SELECT ON  [dbo].[adm_so_hdr_locs_access_vw] TO [public]
GO
GRANT INSERT ON  [dbo].[adm_so_hdr_locs_access_vw] TO [public]
GO
GRANT DELETE ON  [dbo].[adm_so_hdr_locs_access_vw] TO [public]
GO
GRANT UPDATE ON  [dbo].[adm_so_hdr_locs_access_vw] TO [public]
GO
