...
AS
    SELECT ISNULL(x.dim_id, d.id) AS part_no ,
           ...
           CASE WHEN ISNULL(bm.lens_base, '') = '' THEN '6 base lenses'
                ELSE bm.lens_base
           END AS lens_base ,
           bm.front_price ,
           bm.temple_price ,
           ...
           v.varImported ,
           v.varImportDate ,
           ISNULL(CASE WHEN v.variant_release_date = '1/1/1900' THEN NULL
                       ELSE v.variant_release_date
                  END ,
                  bm.release_date) variant_release_date ,
           bm.id model_id ,
           v.id variant_id ,
           d.id dim_id ,
           w.id wsht_id ,
           ...
           x.upc_code ,
           x.date_added ,
           ISNULL(CASE WHEN d.dim_release_date = '1/1/1900' THEN NULL
                       ELSE d.dim_release_date
                  END ,
                  bm.release_date) dim_release_date ,
           bm.model_lead_time ,
    ...
    FROM   cvo_cmi_models bm
           ...
           LEFT JOIN cvo_cmi_worksheet w ON ( v.model_id = w.model_id )
