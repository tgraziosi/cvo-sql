...
create view [dbo].[arcm2_tmp4_vw] as
  select 
	t2.address_name,	 
	t2.customer_code, 	
	t1.doc_ctrl_num, 	     
  ...
  from 
	arinppdt t1, armaster t2, arcm2_tmp3_vw t3, artrx_inv_vw t4
  where 
...
GO
GRANT SELECT ON  [dbo].[arcm2_tmp4_vw] TO [public]
GO
GRANT INSERT ON  [dbo].[arcm2_tmp4_vw] TO [public]
GO
GRANT DELETE ON  [dbo].[arcm2_tmp4_vw] TO [public]
GO
GRANT UPDATE ON  [dbo].[arcm2_tmp4_vw] TO [public]
GO
