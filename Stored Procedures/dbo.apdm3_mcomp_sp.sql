...
CREATE PROC [dbo].[apdm3_mcomp_sp] @WhereClause varchar(1024)='' AS
...
SELECT * FROM #apdm3_temp ORDER BY company_name

DROP TABLE #apdm3_temp


GO
GRANT EXECUTE ON  [dbo].[apdm3_mcomp_sp] TO [public]
GO
