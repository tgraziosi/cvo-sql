...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[cvo_brand_kpi_orders50_sp] 
@brand varchar(10), 
...
----begin
    ...
    and o.date_entered >= (DATEADD(m, -@months, DATEADD(dd, datediff(dd, 0,@RollingToMonth) + 0,0)) + 1)
    AND o.date_entered < DATEADD(dd, datediff(dd, 0,@RollingToMonth) + 1,0)
...
GO
GRANT EXECUTE ON  [dbo].[cvo_brand_kpi_orders50_sp] TO [public]
GO
