...
GO
    ...
    CREATE PROCEDURE [dbo].[icv_authorize_sp] 	@IAS_Option int, @IAS_String varchar(255) = '', @IAS_Name varchar(30) = '',
					...
					@IAS_Expiration varchar(30) = '', @IAS_Amount float = 0.00, @IAS_Preview smallint = 1, @IAS_CCATrxType CHAR(2) = 'C1', @customer_code VARCHAR(255) = '', @nat_cur_code varchar(8) = '', @csc varchar(5) = '' 
    AS
