...
CREATE TABLE #cmi
    (
        part_no              INT,
        cmi_model_id         SMALLINT,
        Collection           VARCHAR(40),
        CollectionName       VARCHAR(40),
        model                VARCHAR(8000),
        short_model          CHAR(8),
        ...
        RES_type             VARCHAR(16),
        case_part            VARCHAR(255),
        frame_category       VARCHAR(255),
        front_material       VARCHAR(255),
        temple_material      VARCHAR(255),
        nose_pads            VARCHAR(255),
        hinge_type           VARCHAR(40),
        release_date         DATETIME,
        prim_img             TINYINT,
        ColorGroupCode       VARCHAR(40),
        colorname            VARCHAR(40),
        ...
        component_3          VARCHAR(255),
        spare_temple_length  VARCHAR(255),
        asterisk_1           VARCHAR(255),
        asterisk_2           VARCHAR(255),
        asterisk_3           VARCHAR(255),
        varImported          SMALLINT,
        varImportDate        DATETIME,
        variant_release_date DATETIME,
        model_id             SMALLINT,
        variant_id           SMALLINT,
        dim_id               BIGINT,
        wsht_id              SMALLINT,
        clips_available      SMALLINT,
        ...
        ws_ship3_qty         INT,
        img_sku              VARCHAR(255),
        print_flag           VARCHAR(24),
        upc_code             VARCHAR(20),
        date_added           DATETIME,
        dim_release_date     DATETIME,
        model_lead_time      VARCHAR(30),
...
SELECT cmi.part_no ,
       ...
       cmi.Collection ,
       cmi.CollectionName ,
       UPPER(cmi.model) model ,
       cmi.short_model ,
       cmi.PrimaryDemographic ,
       cmi.target_age ,
       cmi.eye_shape ,
       cmi.RES_type ,
       cmi.case_part ,
   ...
   --    CASE WHEN ISNULL(specialty_fit,'Regular Fit') <> 'Regular Fit' AND ISNULL(cmi.special_program,'') > '' THEN cmi.specialty_fit
       ...
       cmi.progressive_type ,
       cmi.component_1 ,
       cmi.component_2 ,
       cmi.component_3 ,
       cmi.spare_temple_length ,
       cmi.asterisk_1 ,
       cmi.asterisk_2 ,
       cmi.asterisk_3 ,
       cmi.varImported ,
