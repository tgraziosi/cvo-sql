...
-- Update UPC codes into inv_master
        ...
        SET     upc_code = u.UPC
        FROM    inv_master i
                JOIN uom_id_code u ON i.part_no = u.part_no
...
;
        WITH    c AS ( SELECT   part_no ,
                                dbo.f_cvo_get_part_tl_status(part_no,
                                                              GETDATE()) ryg_stat
