...
SET ANSI_NULLS OFF
GO
CREATE PROC [dbo].[mbbmspSheetsFromDimensionSetList]
            @PlanID		int,
            @DimensionSet	varchar(255)
	------------------------------------------------
	--@PlanID of zero indicates all plans         --
...
************************************************************************************/
	...
	SELECT 		SheetID, '', '', ''
        ...
        WHERE           (PlanID = @PlanID OR @PlanID = 0)
        AND             SheetType = 0
	...
	WHERE           (s.PlanID = @PlanID or @PlanID = 0)
        AND             s.SheetType = 0
	...
	---------------------------------------------------------
	--Insert sheet info #mbbmSheetsFromDimensionSetList--
	---------------------------------------------------------
	INSERT #mbbmSheetsFromDimensionSetList
...
END
GO
GRANT EXECUTE ON  [dbo].[mbbmspSheetsFromDimensionSetList] TO [Analytics]
GO
GRANT EXECUTE ON  [dbo].[mbbmspSheetsFromDimensionSetList] TO [public]
GO
