...
CREATE PROCEDURE [dbo].[tdc_master_pack_stl_unload_cartons_sp]
(
	@CARTON_NO	INT
)
...
BEGIN
	...
	BEGIN
		UPDATE tdc_carton_tx 
		   SET stl_status = 'N', stlbin_no = NULL 
...
END
GO
GRANT EXECUTE ON  [dbo].[tdc_master_pack_stl_unload_cartons_sp] TO [public]
GO
