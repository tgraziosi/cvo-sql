...
CREATE PROCEDURE [dbo].[adm_calculate_consinvtax_wrap] @doc_ctrl_num varchar(16),
...
declare @err int
  ...
  EXEC dbo.adm_calculate_consinvtax @doc_ctrl_num, @err OUT, @doctype, @trx_ctrl_num, @debug

  exec adm_get_tax_detail 0, 0, @err, 0, @err_msg out
  return @err
END 
GO
GRANT EXECUTE ON  [dbo].[adm_calculate_consinvtax_wrap] TO [public]
GO
