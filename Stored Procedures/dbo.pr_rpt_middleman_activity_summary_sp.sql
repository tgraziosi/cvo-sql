...
CREATE PROCEDURE [dbo].[pr_rpt_middleman_activity_summary_sp]	@contract_status	smallint = 0,	
...
GO
GRANT EXECUTE ON  [dbo].[pr_rpt_middleman_activity_summary_sp] TO [public]
GO
