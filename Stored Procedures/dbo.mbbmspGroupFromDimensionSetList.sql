...
SET ANSI_NULLS OFF
GO
CREATE PROC [dbo].[mbbmspGroupFromDimensionSetList]
            @PlanID		int,
...
************************************************************************************/
	...
	---------------------------------------------------------
	--Insert distinct groups #mbbmGroupFromDimensionSetList--
	---------------------------------------------------------
	INSERT #mbbmGroupFromDimensionSetList
	SELECT DISTINCT GroupKey
	FROM #mbbmSheetRecursion d INNER JOIN mbbmPlanSheetRev74 r ON d.SheetID = r.SheetID 
             INNER JOIN mbbmPlanGrp74 g ON r.RevisionID = g.RevisionID 
	WHERE d.Dimensions = @DimensionSet
	AND   g.Publish = 1
	ORDER BY GroupKey

END
GO
GRANT EXECUTE ON  [dbo].[mbbmspGroupFromDimensionSetList] TO [Analytics]
GO
GRANT EXECUTE ON  [dbo].[mbbmspGroupFromDimensionSetList] TO [public]
GO
