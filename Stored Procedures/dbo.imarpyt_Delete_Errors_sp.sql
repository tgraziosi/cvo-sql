...
GO
    ...
    CREATE PROC
[dbo].[imarpyt_Delete_Errors_sp] @imarpyt_Delete_Errors_sp_Transaction_Type INT = 0,
                         @userid INT = 0
    AS
    ...
    SET @Routine_Name = 'imarpyt_Delete_Errors_sp'        
    --
    -- Obtain company_code.
    --
...
Error_Return:
    RETURN -1    
GO
GRANT EXECUTE ON  [dbo].[imarpyt_Delete_Errors_sp] TO [public]
GO
