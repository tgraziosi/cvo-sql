...
GO
    ...
    CREATE procedure 
[dbo].[imglchrt_Validate_sp] @imglchrt_Validate_sp_Batch_Number INT = 0,
                     @imglchrt_Validate_sp_Starting_Record_Number INT = 0,
                     @imglchrt_Validate_sp_Ending_Record_Number INT = 0,
                     @imglchrt_Validate_sp_Dummy_1 INT = 0,
                     @debug_level INT = 0,
                     @imglchrt_Validate_sp_Dummy_2 INT = 0,
                     @imglchrt_Validate_sp_Import_Identifier INT = 0,
                     @userid INT = 0,
                     @imglchrt_Validate_sp_Application_Name VARCHAR(30) = 'Import Manager',
                     @imglchrt_Validate_sp_Override_User_Name VARCHAR(30) = ''
    AS
    ...
    SET @Routine_Name = 'imglchrt_Validate_sp'        
    IF @debug_level >= 3
    ...
    IF @imglchrt_Validate_sp_Import_Identifier = 0
            OR @imglchrt_Validate_sp_Import_Identifier IS NULL
        BEGIN            
        EXEC @SP_Result = imglchrt_sp @company_code = @company_code,
                                      ...
                                      @imglchrt_sp_Import_Identifier = @imglchrt_Validate_sp_Import_Identifier OUTPUT,
                                      @imglchrt_sp_Override_User_Name = @imglchrt_Validate_sp_Override_User_Name
    ...
    ELSE    
        ...
        EXEC @SP_Result = imglchrt_sp @company_code = @company_code,
                                      ...
                                      @imglchrt_sp_process_ctrl_num = @process_ctrl_num OUTPUT,
                                      @imglchrt_sp_dummy = @Dummy OUTPUT,
                                      @imglchrt_sp_Import_Identifier = @imglchrt_Validate_sp_Import_Identifier,
                                      @imglchrt_sp_Override_User_Name = @imglchrt_Validate_sp_Override_User_Name
    ...
    SET @Import_Identifier = @imglchrt_Validate_sp_Import_Identifier
    --
...
Error_Return:
    ...
    RETURN -1    
GO
GRANT EXECUTE ON  [dbo].[imglchrt_Validate_sp] TO [public]
GO
