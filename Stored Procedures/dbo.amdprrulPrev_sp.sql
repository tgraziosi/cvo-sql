...
create procedure [dbo].[amdprrulPrev_sp] 
( 
...
begin 
	...
	select @MSKdepr_rule_code = max(depr_rule_code) from amdprrul where 
	depr_rule_code < @MSKdepr_rule_code 
end 
...
return @@error 
GO
GRANT EXECUTE ON  [dbo].[amdprrulPrev_sp] TO [public]
GO
