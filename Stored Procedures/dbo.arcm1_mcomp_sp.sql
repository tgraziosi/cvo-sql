...
CREATE PROC [dbo].[arcm1_mcomp_sp] @WhereClause varchar(1024)='' 
...
BEGIN
	...
	BEGIN
		...
		BEGIN
			...
			WHERE db_name = @db_name
		END
		select @AUX = ' INSERT INTO #arcm1_comp EXEC arcm1_comp_sp ' + CHAR(39) + REPLACE(@WhereClause, CHAR(39), '''''') + CHAR(39) + ', ' + CHAR(39) + @company_name + CHAR(39)
...
SELECT * FROM #arcm1_comp ORDER BY company_name

DROP TABLE #arcm1_comp




GO
GRANT EXECUTE ON  [dbo].[arcm1_mcomp_sp] TO [public]
GO
