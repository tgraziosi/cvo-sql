...
CREATE PROCEDURE [dbo].[cc_get_summary_custom_age_sp] 	@agebrk_user_id	 		 	varchar(5) = '',
...
IF @terr_from_cust = 1
	UPDATE #age_summary	
	SET	territory_code = t.territory_code
	FROM	#age_summary s, #artrxage_tmp t
...
GO
GRANT EXECUTE ON  [dbo].[cc_get_summary_custom_age_sp] TO [public]
GO
