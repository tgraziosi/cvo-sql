...
CREATE PROCEDURE [dbo].[tdc_tobin_listbox_sfp_sp](  
  @part_no  varchar (30),  
  @location varchar (10),  
  @from_bin varchar (12),
...
-- Add quarantine bins that hold the same stock
-- same part in inventory  
/*
 SELECT @sqlstatement = 'SELECT s.bin_no + ''<S>'', s.bin_no  
      FROM lot_bin_stock s (nolock), tdc_bin_master m (nolock)  
...
RETURN 0  
GO
GRANT EXECUTE ON  [dbo].[tdc_tobin_listbox_sfp_sp] TO [public]
GO
