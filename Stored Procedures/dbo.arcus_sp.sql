...
Copyright (c) 2001 Epicor Software Corporation, 2001
                 All Rights Reserved 
 */
          create proc [dbo].[arcus_sp] @WhereClause varchar(1024)="" as DECLARE  @Sub1 varchar(1024), 
 ...
 select @WhereClause = @Sub1 + @Sub2 end       exec (" select * from arcus_vw " + @WhereClause + @OrderBy ) 
GO
GRANT EXECUTE ON  [dbo].[arcus_sp] TO [public]
GO
