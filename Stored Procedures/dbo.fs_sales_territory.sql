...
CREATE PROCEDURE [dbo].[fs_sales_territory] @sort char(1),@strsort varchar(30),@stat char(1),
...
if @sort='%' 
   begin
	select ship_to_region,sum(price*shipped),
...
GO
GRANT EXECUTE ON  [dbo].[fs_sales_territory] TO [public]
GO
