...
create procedure [dbo].[adm_rpt_relpho] @range varchar(8000) = '0=0',
...
select @sql = 'INSERT INTO #rpt_relpho ( order_no, order_ext, cust_code, customer_name, total_order_amt, 
...
(status = ''B'' or status = ''H'') and  ' + @range + '
ORDER BY ' + @order
...
GO
GRANT EXECUTE ON  [dbo].[adm_rpt_relpho] TO [public]
GO
