...
CREATE PROCEDURE [dbo].[fs_zoom_prev] @sqltext varchar(1000), @key_col varchar(255), 
...
begin
  if @key_col != ''
    select @sqltext = @sqltext + ' , "prev","' + @key_col + '",""'
end 
...
GO
GRANT EXECUTE ON  [dbo].[fs_zoom_prev] TO [public]
GO
