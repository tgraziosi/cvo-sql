...
GO
    ...
    CREATE procedure 
[dbo].[imappyt_Copy_sp] (@imappyt_Copy_sp_Batch_Number INT = 0,
                 @imappyt_Copy_sp_Starting_Record_Number INT = 0,
                 @imappyt_Copy_sp_Ending_Record_Number INT = 0,
                 @imappyt_Copy_sp_Dummy_1 INT = 0,
                 @debug_level INT = 0,
                 @imappyt_Copy_sp_Dummy_2 INT = 0,
                 @imappyt_Copy_sp_Import_Identifier INT = 0,
                 @userid INT = 0,
                 @imappyt_Copy_sp_Dummy_3 VARCHAR(40),
                 @imappyt_Copy_sp_Dummy_4 VARCHAR(40),
                 @imappyt_Copy_sp_Application_Name VARCHAR(30) = 'Import Manager',
                 @imappyt_Copy_sp_Override_User_Name VARCHAR(30) = '',
                 @imappyt_Copy_sp_Dummy_5 INT = NULL)
    AS
    ...
    SET @Routine_Name = 'imappyt_Copy_sp'        
    IF @debug_level >= 3
    ...
    --
    IF @debug_level >= 3
        SELECT '(3): ' + @Routine_Name + ': Before imappyt_sp.'
    IF @imappyt_Copy_sp_Import_Identifier = 0    
            OR @imappyt_Copy_sp_Import_Identifier IS NULL
        BEGIN        
        EXEC @SP_Result = imappyt_sp @company_code = @company_code,
                                     ...
                                     @imappyt_sp_Import_Identifier = @imappyt_Copy_sp_Import_Identifier OUTPUT,
                                     @imappyt_sp_Override_User_Name = @imappyt_Copy_sp_Override_User_Name
    ...
    ELSE    
        ...
        EXEC @SP_Result = imappyt_sp @company_code = @company_code,
                                     ...
                                     @imappyt_sp_process_ctrl_num = @process_ctrl_num OUTPUT,
                                     @imappyt_sp_dummy = @Dummy OUTPUT,
                                     @imappyt_sp_Import_Identifier = @imappyt_Copy_sp_Import_Identifier,
                                     @imappyt_sp_Override_User_Name = @imappyt_Copy_sp_Override_User_Name
    ...
    SET @Import_Identifier = @imappyt_Copy_sp_Import_Identifier
    --
...
Error_Return:
    ...
    RETURN -1    
GO
GRANT EXECUTE ON  [dbo].[imappyt_Copy_sp] TO [public]
GO
