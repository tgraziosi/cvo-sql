...
CREATE proc [dbo].[apstl_comp_sp] @WhereClause varchar(1024)='', @comp_name varchar(30) as  
DECLARE
	@OrderBy	varchar(255)
...
create clustered index pst_1 on #Settlements_comp (vendor_name,vendor_code,settlement_ctrl_num)
