...
CREATE PROCEDURE [dbo].[amch_vwUpdate_sp]
(
	@timestamp				timestamp,
	@company_id				smallint,
...
BEGIN
	...
	BEGIN
		...
		EXEC	 	amGetErrorMessage_sp 20004, "tmp/amchup.sp", 203, "amapdet", @error_message = @message OUT
	...
	IF @ts <> @timestamp
	BEGIN
		EXEC	 	amGetErrorMessage_sp 20003, "tmp/amchup.sp", 210, "amapdet", @error_message = @message OUT
...
RETURN 0
GO
GRANT EXECUTE ON  [dbo].[amch_vwUpdate_sp] TO [public]
GO
