...
create procedure [dbo].[amassetPrevRow_sp] 
( 
...
declare @MSKasset_ctrl_num smControlNumber, @MSKcompany_id smCompanyID 
...
return @@error 
GO
GRANT EXECUTE ON  [dbo].[amassetPrevRow_sp] TO [public]
GO
