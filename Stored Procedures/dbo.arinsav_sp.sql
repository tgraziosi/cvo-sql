...
CREATE  PROCEDURE [dbo].[arinsav_sp]  @proc_user_id smallint, @new_batch_code varchar(16) OUTPUT
...
BEGIN
	...
	(
		...
		discount_prc,		calc_tax,			reference_code,
		cust_po,		org_id
	)				
	SELECT  
		trx_ctrl_num,		doc_ctrl_num,
...
END
GO
GRANT EXECUTE ON  [dbo].[arinsav_sp] TO [public]
GO
