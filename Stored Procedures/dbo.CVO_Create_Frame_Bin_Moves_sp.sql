...
BEGIN
	...
	BEGIN
		...
		IF NOT EXISTS (SELECT 1 FROM tdc_pick_queue WHERE trans = 'MGTB2B' AND trans_type_no = @order_no
		...
		BEGIN
			...
			INSERT INTO tdc_pick_queue (trans_source, trans, priority, seq_no, location, trans_type_no, 
