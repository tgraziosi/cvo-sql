...
create procedure [dbo].[amcat_vwLastFilt_sp] 
( 
...
select @rowsfound = 0 
select 	@MSKcategory_code 	= max(category_code) 
from	amcat_vw 
where 	category_code 		like RTRIM(@category_code_filter)
...
return @@error 
GO
GRANT EXECUTE ON  [dbo].[amcat_vwLastFilt_sp] TO [public]
GO
