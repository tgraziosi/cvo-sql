...
GO
    ...
    CREATE PROC
[dbo].[imglchrt_Delete_Errors_sp] @imglchrt_Delete_Errors_sp_Transaction_Type INT = 0,
                          @userid INT = 0
    AS
    ...
    SET @Routine_Name = 'imglchrt_Delete_Errors_sp'        
    --
    -- Obtain company_code
    --
...
Error_Return:
    RETURN -1    
GO
GRANT EXECUTE ON  [dbo].[imglchrt_Delete_Errors_sp] TO [public]
GO
