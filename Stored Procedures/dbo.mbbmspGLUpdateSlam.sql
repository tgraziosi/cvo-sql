...
SET ANSI_NULLS OFF
GO
CREATE PROC [dbo].[mbbmspGLUpdateSlam]
...
************************************************************************************/
	...
	UPDATE mbbmTmpUpdateGLSumSlam750 SET EndBal = (SELECT SUM(b.NetChange) FROM mbbmTmpUpdateGLSumSlam750 b, 
		...
		BETWEEN p.YearStartDate AND a.PerEnd AND a.CompanyCode = b.CompanyCode AND a.UserID = b.UserID AND b.Status = a.Status) 
...
END
GO
GRANT EXECUTE ON  [dbo].[mbbmspGLUpdateSlam] TO [Analytics]
GO
GRANT EXECUTE ON  [dbo].[mbbmspGLUpdateSlam] TO [public]
GO
