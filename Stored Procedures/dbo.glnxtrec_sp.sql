...
I:\vcs\GL\PROCS\glnxtrec.SPv - e7.2.2 : 1.1
...
CREATE PROCEDURE [dbo].[glnxtrec_sp]
...
SELECT	@mask=recurring_code_mask, 
	@next_number=next_recurring_code
FROM	glnumber
...
BEGIN
	...
	UPDATE	glnumber 
	SET	next_recurring_code=@next_number+1
...
/**/                                              
GO
GRANT EXECUTE ON  [dbo].[glnxtrec_sp] TO [public]
GO
