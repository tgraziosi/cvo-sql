...
-- Description:	FIND OVER DUE PO'S FOR THE OUT OF STOCK REPORT
-- EXEC CVO_OOS_OVERDUEPOS_SP 
-- =============================================
CREATE PROCEDURE [dbo].[CVO_OOS_OVERDUEPOS_SP] 
AS
BEGIN
	SET NOCOUNT ON;
...
[Next PO Inhouse Date] as [ORIG Next PO Inhouse Date],
...
ISNULL((select sum(qty) from cvo_bin_inquiry_vw t11 where bin_no like 'ct%' and t1.part_no=t11.part_no),0) CTBIN
...
and [Next PO Inhouse Date] <= getdate()
