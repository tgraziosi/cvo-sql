...
CREATE PROC [dbo].[tdc_3pl_labor_total_qty_received]
...
SELECT @select_clause = 'SELECT ISNULL(SUM(qty), 0) 
...
RETURN @qty
GO
GRANT EXECUTE ON  [dbo].[tdc_3pl_labor_total_qty_received] TO [public]
GO
