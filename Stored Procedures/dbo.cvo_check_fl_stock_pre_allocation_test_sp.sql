...
CREATE PROC [dbo].[cvo_check_fl_stock_pre_allocation_test_sp]	@order_no_in int,
														@order_ext_in int														
AS
BEGIN
	-- Directives
...
--			 Set the in_tock figure
		  ...
		  SELECT '@sa_qty',@sa_qty
			...
			SELECT 'FINAL',((@in_stock - (@alloc_qty + @quar_qty + @sa_qty)))
...
END
GO
GRANT EXECUTE ON  [dbo].[cvo_check_fl_stock_pre_allocation_test_sp] TO [public]
GO
