...
CREATE PROCEDURE [dbo].[gltc_voucher_profile_sp]
	...
	select @posted_flag =  posted_flag, @trx_type = trx_type  from gltcrecon where trx_ctrl_num = @trx_ctrl_num
			...
			if (@posted_flag = 1)
				...
				select a.trx_ctrl_num, a.doc_ctrl_num, a.apply_to_num, a.po_ctrl_num, a.ticket_num,
					...
					a.approval_code, a.tax_code,  a.posting_code, a.terms_code,
					a.branch_code, a.class_code, a.fob_code, a.recurring_code, a.comment_code, 
					a.date_entered, a.date_doc, a.date_applied,	a.date_required, a.date_received, 
					a.date_due, a.date_aging, a.date_posted, a.date_paid, a.date_discount,
					a.amt_gross, a.amt_discount, a.amt_freight, a.amt_misc, a.amt_tax, 
					a.amt_net, a.amt_paid_to_date, balance = (a.amt_net - a.amt_paid_to_date), a.doc_desc,
					...
					from apvohdr a, apmaster b, apvend c 
					...
					a.branch_code, a.class_code, a.fob_code, a.recurring_code, a.comment_code, 
					a.date_entered, a.date_doc, a.date_applied,	a.date_required, a.date_received, 
					a.date_due, a.date_aging, date_posted = '', date_paid = '', a.date_discount,
					a.amt_gross, a.amt_discount, a.amt_freight, a.amt_misc, a.amt_tax, 
					a.amt_net, amt_paid_to_date = '', balance = (a.amt_net), a.doc_desc,
					c.vendor_code, c.vendor_name, 
					b.pay_to_code, 
					CASE WHEN b.pay_to_code = '' THEN ''
					ELSE b.address_name 
...
GO
GRANT EXECUTE ON  [dbo].[gltc_voucher_profile_sp] TO [public]
GO
