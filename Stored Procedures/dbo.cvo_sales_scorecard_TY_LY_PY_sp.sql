...
-- EXEC CVO_Sales_ScoreCard_ty_LY_py_SP '1/1/2015', '12/31/2015'
-- 051315 - add  qual st ord_value
-- =============================================
CREATE PROCEDURE [dbo].[cvo_sales_scorecard_TY_LY_PY_sp] 
...
declare @datefrompy datetime, @datetopy datetime
select @datefrompy = dateadd(yy,-2,@datefrom), @datetopy = dateadd(yy,-2,@dateto)
