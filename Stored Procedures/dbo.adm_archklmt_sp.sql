...
CREATE PROC [dbo].[adm_archklmt_sp] 	@customer_code varchar(10), 
				@date_entered	int,
				@ordno		int, 
				@ordext		int AS
...
select @payamt = isnull( (select sum(amt_payment) from ord_payment
...
if @ordstat >= 'R' and @ordstat < 'V' begin
...
GO
GRANT EXECUTE ON  [dbo].[adm_archklmt_sp] TO [public]
GO
