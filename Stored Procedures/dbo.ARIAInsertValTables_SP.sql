...
CREATE PROC [dbo].[ARIAInsertValTables_SP]	
AS
...
BEGIN
	...
	INSERT #arvalchg(	trx_ctrl_num,		doc_ctrl_num,		doc_desc,
				...
				amt_tax_included ,      org_id,                interbranch_flag,        
                                temp_flag2                
			) 
...
END
GO
GRANT EXECUTE ON  [dbo].[ARIAInsertValTables_SP] TO [public]
GO
