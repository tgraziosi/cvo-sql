...
-- v1.4 End
	...
	AND		a.order_no <> 0
	AND		a.status IN (0,1)
	AND		a.order_ext > 0 -- v1.8
	-- v1.8 AND		CONVERT(varchar(10),b.allocation_date,120) <= CONVERT(varchar(10),GETDATE(),120)
	...
	SELECT	@alloc_qty = (i.in_stock - (t.allocated_amt + t.sa_qty + t.quarantined_amt)) -- v1.7 Remove ABS
