...
SET ANSI_NULLS OFF
GO
CREATE PROC [dbo].[mbbmspGLUpdatePlat41] 
...
************************************************************************************/
	...
	IF @PostProc = 0 BEGIN
	  ...
	  SELECT SequenceID, @BudgetKey, Acct, Acct_Dim1, NetChange, EndBal, PerEnd, seg1_code, seg2_code, seg3_code, seg4_code, 0, 
	    @HomeCurrency, 1, 1, NetChange, EndBal, NetChange, EndBal FROM mbbmTmpUpdateGLSum74, glchart 
...
END
GO
GRANT EXECUTE ON  [dbo].[mbbmspGLUpdatePlat41] TO [Analytics]
GO
GRANT EXECUTE ON  [dbo].[mbbmspGLUpdatePlat41] TO [public]
GO
