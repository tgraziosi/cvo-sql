...
create procedure [dbo].[amastbk_amdprhstChildFirst_sp] 
( 
...
select @MSKeffective_date = min(effective_date) 
from amdprhst 
where 
	co_asset_book_id = @co_asset_book_id and 
	effective_date > @MSKeffective_date 
...
return @@error 
GO
GRANT EXECUTE ON  [dbo].[amastbk_amdprhstChildFirst_sp] TO [public]
GO
