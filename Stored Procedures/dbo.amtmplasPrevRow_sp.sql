...
create procedure [dbo].[amtmplasPrevRow_sp] 
( 
...
declare @MSKtemplate_code smTemplateCode, @MSKcompany_id smCompanyID 
...
return @@error 
GO
GRANT EXECUTE ON  [dbo].[amtmplasPrevRow_sp] TO [public]
GO
