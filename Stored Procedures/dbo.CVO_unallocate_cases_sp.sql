...
CREATE PROCEDURE [dbo].[CVO_unallocate_cases_sp] @order_no INT, @ext INT AS
BEGIN
	...
	CREATE TABLE #so_alloc_management (                                                         
		...
		WHERE l.order_no = @order_no AND l.order_ext = @ext AND c.is_case = '1'
...
END
GO
GRANT EXECUTE ON  [dbo].[CVO_unallocate_cases_sp] TO [public]
GO
