...
CREATE PROCEDURE [dbo].[scm_pb_set_dw_xfer_ship_list_sp]
...
, @inv_master_lb_tracking char(1), @display_line integer
, @inv_master_allow_fractions integer, @c_tdc_status varchar(35)
...
begin
  rollback tran
  RAISERROR 832115 'You cannot insert a new transfer line from the transfer ship screen'
  RETURN 
end
if @typ = 'U'
begin
...
GO
GRANT EXECUTE ON  [dbo].[scm_pb_set_dw_xfer_ship_list_sp] TO [public]
GO
