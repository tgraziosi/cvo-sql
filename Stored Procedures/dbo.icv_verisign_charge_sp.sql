...
SET ANSI_NULLS ON
GO
-- v1.0 CB 22/06/2016 - #1548 Email credit card confirmation
CREATE PROCEDURE [dbo].[icv_verisign_charge_sp] 
AS    
BEGIN    
	...
	BEGIN    
		...
		BEGIN    
			...
			BEGIN    
				...
				-- v1.0 Start
				EXEC dbo.cvo_email_cc_confirmation_sp @customer_code, @xAmt, @nat_cur_code
				-- v1.0 End
...
END 
GO
GRANT EXECUTE ON  [dbo].[icv_verisign_charge_sp] TO [public]
GO
