...
BEGIN
    ...
    FROM   #terr
           ...
           LEFT OUTER JOIN dbo.adm_arcontacts AS aa (nolock) ON aa.customer_code = ar.customer_code AND aa.contact_code = 'ASAMB'
           ...
           LEFT OUTER  JOIN (   SELECT null brand, 
                          ...
                          WHERE (bb.first_order_date IS NOT NULL OR aa.contact_code = 'ASAMB');
