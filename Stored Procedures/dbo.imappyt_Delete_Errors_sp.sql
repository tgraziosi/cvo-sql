...
GO
    ...
    CREATE PROC
[dbo].[imappyt_Delete_Errors_sp] @imappyt_Delete_Errors_sp_Transaction_Type INT = 0,
                         @userid INT = 0
    AS
    ...
    SET @Routine_Name = 'imappyt_Delete_Errors_sp'        
    --
    -- Obtain company_code.
    --
...
Error_Return:
    RETURN -1    
GO
GRANT EXECUTE ON  [dbo].[imappyt_Delete_Errors_sp] TO [public]
GO
