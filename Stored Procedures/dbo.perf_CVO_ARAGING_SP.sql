...
CREATE PROCEDURE [dbo].[perf_CVO_ARAGING_SP] (@WHERECLAUSE VARCHAR(1024))  
AS      
...
insert dbo.performance select 1, GETDATE()
...
BEGIN -- CVO_ARAGING_SP DATA      
 ...
 -- CREATE INDEX #ARTRXAGE_IDX ON #ARTRXAGE_TMP   (customer_code, doc_ctrl_num)    -- CRAIG
 -- create index #artrxage_idx1 on #artrxage_tmp (amount)  -- CRAIG    
...
insert dbo.performance select 2, GETDATE()

	-- Call BG Data Proc
--	EXEC cvo_bg_get_document_data_sp

INSERT #bg_data
select * from cvo_artrxage
 
insert dbo.performance select 3, GETDATE()
  
	CREATE INDEX #bg_data_ind122 ON #bg_data (customer_code, doc_ctrl_num)

insert dbo.performance select 4, GETDATE()
...
insert dbo.performance select 5, GETDATE()
...
insert dbo.performance select 6, GETDATE()

 CREATE INDEX #cust_ind_0 ON #cust (child) -- CRAIG   

insert dbo.performance select 7, GETDATE()
...
insert dbo.performance select 8, GETDATE()
   
 CREATE INDEX #ARTRXAGE_IDX ON #ARTRXAGE_TMP   (customer_code, doc_ctrl_num)    -- CRAIG
 create index #artrxage_idx1 on #artrxage_tmp (amount)  -- CRAIG

 insert dbo.performance select 8.5, GETDATE()
...
insert dbo.performance select 9, GETDATE()
...
insert dbo.performance select 10, GETDATE()
  
 UPDATE #ARTRXAGE_TMP    
 SET  parent = customer_code    
 WHERE parent = ''    

insert dbo.performance select 11, GETDATE()     
...
insert dbo.performance select 12, GETDATE()     
...
insert dbo.performance select 13, GETDATE()     
...
insert dbo.performance select 14, GETDATE()     
...
insert dbo.performance select 15, GETDATE()     

    CREATE INDEX #invoices_idx1 ON #invoices(customer_code, doc_ctrl_num )      
    
insert dbo.performance select 16, GETDATE()     
...
insert dbo.performance select 20, GETDATE()     
  
 CREATE INDEX #open_idx1 ON #open( doc_ctrl_num)      
       
insert dbo.performance select 21, GETDATE()     
...
insert dbo.performance select 22, GETDATE()     
...
insert dbo.performance select 24, GETDATE()     
...
insert dbo.performance select 25, GETDATE()     
...
insert dbo.performance select 26, GETDATE()     

   DROP TABLE #cm      
  
 DELETE #invoices WHERE trx_type IS NULL  
  
insert dbo.performance select 27, GETDATE()     
...
insert dbo.performance select 28, GETDATE()     
...
insert dbo.performance select 29, GETDATE()     
...
insert dbo.performance select 30, GETDATE()     
...
insert dbo.performance select 31, GETDATE()     
...
insert dbo.performance select 33, GETDATE()     
...
insert dbo.performance select 34, GETDATE()         
...
insert dbo.performance select 35, GETDATE()     
   
 EXEC cvo_set_bucket_sp      

insert dbo.performance select 36, GETDATE()     
...
insert dbo.performance select 37, GETDATE()              
...
insert dbo.performance select 38, GETDATE()     
   
 -- v3.2 Start
 SELECT DISTINCT * INTO #invoices2
 FROM	#invoices

insert dbo.performance select 39, GETDATE()     

 TRUNCATE TABLE #invoices

insert dbo.performance select 40, GETDATE()     

 INSERT #invoices
 SELECT * FROM #invoices2

insert dbo.performance select 41, GETDATE()     
...
insert dbo.performance select 42, GETDATE()     
...
insert dbo.performance select 43, GETDATE()     
...
insert dbo.performance select 44, GETDATE()         
...
insert dbo.performance select 47, GETDATE()     
...
insert dbo.performance select 48, GETDATE()     
 UPDATE F      
 SET AVGDAYSLATE = A.AVGDAYSLATE      
 FROM #AVG A, #FINAL F      
 WHERE A.CUSTOMER_CODE = F.CUSTOMER_CODE      

insert dbo.performance select 49, GETDATE()     
...
insert dbo.performance select 50, GETDATE()     
...
--   @date_asof as date_asof,    
 ...
 --select * into dbo.temp_cvo_araging from #FINAL
 select * into dbo.temp_cvo_araging_new from #FINAL

insert dbo.performance select 51, GETDATE()     
...
GO
GRANT EXECUTE ON  [dbo].[perf_CVO_ARAGING_SP] TO [public]
GO
