...
CREATE PROCEDURE [dbo].[ARCAEditHold_SP]	@put_on_hold smallint,
...
BEGIN
	...
	IF ( @debug_level > 1 ) SELECT CONVERT(char,getdate(),109) + "  " + "tmp/arcaeh.sp" + ", line " + STR( 26, 5 ) + " -- ENTRY: "
	...
	IF ( @debug_level > 1 ) SELECT CONVERT(char,getdate(),109) + "  " + "tmp/arcaeh.sp" + ", line " + STR( 106, 5 ) + " -- EXIT: "
	RETURN 0
END
GO
GRANT EXECUTE ON  [dbo].[ARCAEditHold_SP] TO [public]
GO
