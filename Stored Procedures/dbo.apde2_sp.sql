...
CREATE PROCEDURE [dbo].[apde2_sp] @only_errors smallint,
...
IF ( @debug_level > 1 ) SELECT CONVERT(char,getdate(),109) + "  " + "tmp/apde2.sp" + ", line " + STR( 32, 5 ) + " -- ENTRY: "
...
IF ( @debug_level > 1 ) SELECT CONVERT(char,getdate(),109) + "  " + "tmp/apde2.sp" + ", line " + STR( 110, 5 ) + " -- EXIT: "

RETURN 0
GO
GRANT EXECUTE ON  [dbo].[apde2_sp] TO [public]
GO
