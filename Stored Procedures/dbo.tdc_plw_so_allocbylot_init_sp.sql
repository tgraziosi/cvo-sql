...
SET ANSI_NULLS ON
GO
  -- v1.0 CB 09/01/2013 - Issue #1067 - Implement unalloc/alloc by lot bin for custom frames
 -- v1.1 CB 21/05/2013 - Replace cursors
  
CREATE PROCEDURE [dbo].[tdc_plw_so_allocbylot_init_sp]  
   @location   varchar(10),  
   @part_no    varchar(30),  
   @order_no   int,  
   @order_ext   int,  
...
GO
GRANT EXECUTE ON  [dbo].[tdc_plw_so_allocbylot_init_sp] TO [public]
GO
