...
CREATE PROC [dbo].[ARCBUPDateCustSummary_SP] @customer_code varchar(8)
...
DECLARE	@precision_oper	smallint,
	...
	AND	age.customer_code = @customer_code
...
GO
GRANT EXECUTE ON  [dbo].[ARCBUPDateCustSummary_SP] TO [public]
GO
