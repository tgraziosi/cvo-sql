...
CREATE PROC [dbo].[arin2_mcomp_sp] @WhereClause varchar(1024)='' AS
...
SELECT * FROM #arin2_temp ORDER BY company_name

DROP TABLE #arin2_temp

GO
GRANT EXECUTE ON  [dbo].[arin2_mcomp_sp] TO [public]
GO
