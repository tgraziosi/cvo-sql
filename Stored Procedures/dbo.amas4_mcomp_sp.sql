...
CREATE PROC [dbo].[amas4_mcomp_sp] @WhereClause varchar(1024)='' AS
...
SELECT * INTO #amas4_comp FROM amas4
DELETE #amas4_comp
...
SELECT * FROM #amas4_comp ORDER BY company_name

DROP TABLE #amas4_comp

GO
GRANT EXECUTE ON  [dbo].[amas4_mcomp_sp] TO [public]
GO
