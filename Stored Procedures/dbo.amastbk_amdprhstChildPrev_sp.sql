...
create procedure [dbo].[amastbk_amdprhstChildPrev_sp] 
( 
...
select @MSKeffective_date = max(effective_date) 
from amdprhst 
where 
...
return @@error 
GO
GRANT EXECUTE ON  [dbo].[amastbk_amdprhstChildPrev_sp] TO [public]
GO
