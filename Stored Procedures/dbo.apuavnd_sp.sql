...
BEGIN
	...
	SET	exists_flag = 1
	FROM	apactvnd
	WHERE	apactvnd.vendor_code = #vendor_bal.vendor_code
	...
	SET	amt_balance 		= bal.amt_balance_home,
		...
		last_trx_time		 = 1
	FROM	#vendor_bal	bal
	WHERE	bal.vendor_code = apactvnd.vendor_code
	AND	exists_flag = 1
...
/**/                                              
GO
GRANT EXECUTE ON  [dbo].[apuavnd_sp] TO [public]
GO
