...
CREATE PROCEDURE	[dbo].[cmbtmkbt_sp] 
...
BEGIN
	...
	BEGIN
		...
		SELECT	@date_applied = MIN( date_applied ),
				@org_id		  = MIN( from_org_id )
		FROM	#cmbatches
		GROUP BY date_applied, from_org_id
...
/**/                                              
GO
GRANT EXECUTE ON  [dbo].[cmbtmkbt_sp] TO [public]
GO
