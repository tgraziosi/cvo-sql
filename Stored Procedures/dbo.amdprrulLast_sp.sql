...
create procedure [dbo].[amdprrulLast_sp] 
( 
...
select @MSKdepr_rule_code = max(depr_rule_code) from amdprrul 
if @MSKdepr_rule_code is null 
begin 
 drop table #temp 
 return 
end 
...
return @@error 
GO
GRANT EXECUTE ON  [dbo].[amdprrulLast_sp] TO [public]
GO
