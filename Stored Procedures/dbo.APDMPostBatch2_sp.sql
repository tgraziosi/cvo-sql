...
I:\vcs\AP\PROCS\apdmpb2.SPv - e7.2.2 : 1.0
...
CREATE PROCEDURE [dbo].[APDMPostBatch2_sp] 
...
IF ( @debug_level > 1 ) SELECT CONVERT(char,getdate(),109) + "  " + "tmp/apdmpb2.sp" + ", line " + STR( 41, 5 ) + " -- ENTRY: "
 ...
 EXEC @rf_result = APDMResetFlag_sp 
 								@batch_ctrl_num,
									@client_id,
									@user_id,
									@process_group_num,
 ...
 EXEC @result = APDMPostTemp_sp @batch_ctrl_num, 
									@process_group_num,
								 @user_id,
 	 @cm_exist,
									@period_end,
 ...
 IF( @result != 0 )
 	...
 	IF ( @debug_level > 1 ) SELECT CONVERT(char,getdate(),109) + "  " + "tmp/apdmpb2.sp" + ", line " + STR( 106, 5 ) + " -- EXIT: "
 RETURN @rf_result 
END
GO
GRANT EXECUTE ON  [dbo].[APDMPostBatch2_sp] TO [public]
GO
