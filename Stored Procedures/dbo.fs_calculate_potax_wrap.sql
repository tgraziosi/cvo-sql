...
CREATE PROCEDURE [dbo].[fs_calculate_potax_wrap] @po varchar(16), @rtntype int=0 ,
@debug int = 0 AS
BEGIN
set nocount on
...
exec dbo.fs_calculate_potax @po,  @err1 OUT , @debug 

      if @rtntype  = 0
		begin
		  exec adm_get_tax_detail @po, 0, @err1
		end
        else
		return @err1
END
GO
GRANT EXECUTE ON  [dbo].[fs_calculate_potax_wrap] TO [public]
GO
