...
CREATE PROCEDURE [dbo].[tdc_print_ctn_sn_pack_list_sp](  
   @user_id    varchar(50),  
...
INSERT INTO #PrintData (data_field, data_value) VALUES ('LP_DEST_ZONE_DESC',    ISNULL(@zone_desc,           ''  ))  INSERT INTO #PrintData (data_field, data_value) VALUES ('LP_BACK_ORD_FLAG',    ISNULL(@back_ord_flag,       ''  ))  
...
EXEC @return_value = tdc_print_label_sp 'PPS', 'CTNSNLIST', 'VB', @station_id  
  
-- IF label hasn't been set up for the station id, try finding a record for the user id  
IF @return_value != 0  
BEGIN  
 EXEC @return_value = tdc_print_label_sp 'PPS', 'CTNSNLIST', 'VB', @user_id  
END  
...
RETURN  
GO
GRANT EXECUTE ON  [dbo].[tdc_print_ctn_sn_pack_list_sp] TO [public]
GO
