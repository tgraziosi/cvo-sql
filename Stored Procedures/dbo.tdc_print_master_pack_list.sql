...
CREATE PROCEDURE [dbo].[tdc_print_master_pack_list]  
   @user_id    varchar(50),  
   @station_id varchar(20),  
   @pack_no    int  
AS  
  
DECLARE @carton_total   int,            @return_value           int,  
 ...
 @status           char    (1), @carton_class      char    (10),   
 @carrier_code     varchar (40), @carton_type       char    (10),    --v2.0  
 @address1           varchar (40),  @name           varchar (40),    
 @address2           varchar (40),   @city    varchar (40),    
 @address3          varchar (40),   @state    varchar (40),  
 @Attention        varchar (40), @zip    varchar (10),  
 @cust_code           varchar (40), @country   varchar (40),  
 @cs_tracking_no         varchar (255), @cs_tx_no   varchar (12),  
 @cs_zone   varchar (10), @cs_oversize   varchar (255),  
 @cs_call_tag_no  varchar (10), @cs_airbill_no   varchar (18),  
 @cs_other   varchar (8), @cs_pickup_no   varchar (10),  
 @cs_dim_weight   varchar (13),   @cs_published_freight varchar (13),   
 @cs_disc_freight  varchar (13), @date_shipped  varchar (20),  
 @Weight       varchar (20),   @freight_to    varchar (30),  
 @cust_freight         varchar (13),   @adjust_rate         varchar (10),   
 @charge_code      varchar (10),   @template_code         varchar (10),  
 @cs_estimated_freight varchar (13), @carton_no  varchar (20),  
 @cs_airbillno   varchar (18),   @printed_on_the_page    int,  
 @order_no  varchar (20), @order_ext  varchar(20),  
 @header_add_note varchar (255),  
 @ord_cust_code varchar(8), @cust_name varchar(40),    --v2.0  
 @ord_pack_qty  varchar(20), @tot_pack_qty varchar(20)    --v2.0  
...
SELECT @cust_code   = cust_code,  
 ...
 LEFT OUTER JOIN arshipv v (NOLOCK) ON mp.carrier_code = v.ship_via_code  
 WHERE pack_no = @pack_no  
  
SELECT @carton_total = COUNT(carton_no) FROM tdc_master_pack_ctn_tbl (NOLOCK) WHERE pack_no = @pack_no  
