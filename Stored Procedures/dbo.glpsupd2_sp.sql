...
CREATE PROCEDURE        [dbo].[glpsupd2_sp] 
...
BEGIN
	...
	IF ( @debug_level > 1 ) SELECT CONVERT(char,getdate(),109) + "  " + "glpsupd2.cpp" + ", line " + STR( 129, 5 ) + " -- ENTRY: "
	...
	IF ( @debug_level > 2 ) SELECT "glpsupd2.cpp" + ", line " + STR( 216, 5 ) + " -- MSG: " + CONVERT(char,@work_time,100) + "Insert prior period records into #updglbal"
	...
	IF ( @debug_level > 2 ) SELECT "glpsupd2.cpp" + ", line " + STR( 233, 5 ) + " -- MSG: " + CONVERT(char,@work_time,100) + "Mark rows which already exist in #updglbal"
	...
	IF ( @debug_level > 2 ) SELECT "glpsupd2.cpp" + ", line " + STR( 275, 5 ) + " -- MSG: " + CONVERT(char,@work_time,100) + "Insert missing records into #updglbal"
	...
	IF ( @debug_level > 2 ) SELECT "glpsupd2.cpp" + ", line " + STR( 375, 5 ) + " -- MSG: " + CONVERT(char,@work_time,100) + "Generate balance rows for future periods in #updglbal"
	...
	IF ( @debug_level > 3 ) SELECT "glpsupd2.cpp" + ", line " + STR( 435, 5 ) + " -- MSG: " + CONVERT(char,@work_time,100) + "Creating #UPDGLBAL"

	


	IF ( @debug_level > 1 ) SELECT "glpsupd2.cpp" + ", line " + STR( 440, 5 ) + " -- MSG: " + CONVERT(char,@work_time,100) + "Exiting - No Error"
	RETURN 0
	...
	IF ( @debug_level > 1 ) SELECT "glpsupd2.cpp" + ", line " + STR( 448, 5 ) + " -- MSG: " + CONVERT(char,@work_time,100) + "Exiting - Error"
	RETURN 1039

END
GO
GRANT EXECUTE ON  [dbo].[glpsupd2_sp] TO [public]
GO
