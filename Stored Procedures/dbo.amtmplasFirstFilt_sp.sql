...
create procedure [dbo].[amtmplasFirstFilt_sp] 
( 
...
select @MSKcompany_id = @company_id_filter 

select 	@MSKtemplate_code 	= min(template_code) 
from 	amtmplas 
where 	template_code 		like RTRIM(@template_code_filter)
...
return @@error 
GO
GRANT EXECUTE ON  [dbo].[amtmplasFirstFilt_sp] TO [public]
GO
