...
CREATE PROCEDURE [dbo].[fs_graph_res] @loc varchar(10), @pn1 varchar(30), @pn2 varchar(30), 
...
begin
   ...
   order by location, part_no, avail_date, demand_source
end

GO
GRANT EXECUTE ON  [dbo].[fs_graph_res] TO [public]
GO
