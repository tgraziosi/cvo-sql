...
create proc [dbo].[appy2_comp_sp] @WhereClause varchar(1024)='', @comp_name varchar(30) as  
DECLARE
...
begin
  ...
  from 
	appydet t1(NOLOCK), apvend t2(NOLOCK), apvohdr t4(NOLOCK), appyhdr t3(NOLOCK) LEFT OUTER JOIN cminpdtl cminpdtl(NOLOCK) ON t3.trx_ctrl_num = cminpdtl.trx_ctrl_num
  where 
...
GO
GRANT EXECUTE ON  [dbo].[appy2_comp_sp] TO [public]
GO
