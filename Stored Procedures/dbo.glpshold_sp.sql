...
CREATE PROCEDURE	[dbo].[glpshold_sp] 
...
BEGIN
	...
	BEGIN
		...
		IF ( @debug_level > 3 ) SELECT "glpshold.cpp" + ", line " + STR( 199, 5 ) + " -- MSG: " + CONVERT(char,@work_time,100) + "Clearing temp tables of transactions with errors"
	...
	IF ( @debug_level > 1 ) SELECT "glpshold.cpp" + ", line " + STR( 225, 5 ) + " -- MSG: " + CONVERT(char,@work_time,100) + "Exiting"	
	RETURN 0
END

GO
GRANT EXECUTE ON  [dbo].[glpshold_sp] TO [public]
GO
