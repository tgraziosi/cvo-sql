...
CREATE PROCEDURE [dbo].[fs_sales_reps] @sort char(1),@strsort varchar(30),@stat char(1),
...
if @sort='%' 
   begin
	select salesperson,sum(price*shipped),
...
GO
GRANT EXECUTE ON  [dbo].[fs_sales_reps] TO [public]
GO
