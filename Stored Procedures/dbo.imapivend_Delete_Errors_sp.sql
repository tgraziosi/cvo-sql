...
GO
    ...
    CREATE PROC
[dbo].[imapivend_Delete_Errors_sp] @imapivend_Delete_Errors_sp_Transaction_Type INT = 0,
                           @userid INT = 0
    AS
    ...
    SET @Routine_Name = 'imapivend_Delete_Errors_sp'        
    --
    -- Obtain company_code
    --
    ...
    DELETE
            ...
            WHERE LTRIM(RTRIM([company_code])) = @company_code 
                    AND [address_type] = @imapivend_Delete_Errors_sp_Transaction_Type
                    AND ([User_ID] = @userid OR @userid = 0)
    RETURN 0
Error_Return:
    RETURN -1    
GO
GRANT EXECUTE ON  [dbo].[imapivend_Delete_Errors_sp] TO [public]
GO
