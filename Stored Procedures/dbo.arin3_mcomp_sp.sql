...
CREATE PROC [dbo].[arin3_mcomp_sp] @WhereClause varchar(1024)='' 
...
BEGIN
	...
	BEGIN
		...
		BEGIN
			...
			WHERE db_name = @db_name
		END
		select @AUX = ' INSERT INTO #arin3_comp EXEC arin3_comp_sp ' + CHAR(39) + REPLACE(@WhereClause, CHAR(39), '''''') + CHAR(39) + ', ' + CHAR(39) + @company_name + CHAR(39)
...
SELECT * FROM #arin3_comp ORDER BY company_name

DROP TABLE #arin3_comp


GO
GRANT EXECUTE ON  [dbo].[arin3_mcomp_sp] TO [public]
GO
