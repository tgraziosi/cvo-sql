...
I:\vcs\AP\PROCS\apvapb2.SPv - e7.2.2 : 1.1
...
CREATE PROCEDURE [dbo].[APVAPostBatch2_sp] 
...
IF ( @debug_level > 1 ) SELECT CONVERT(char,getdate(),109) + "  " + "tmp/apvapb2.sp" + ", line " + STR( 41, 5 ) + " -- ENTRY: "
 ...
 EXEC @rf_result = APVAResetFlag_sp 
 								@batch_ctrl_num,
									@client_id,
									@user_id,
									@process_group_num,
 ...
 EXEC @result = APVAPostTemp_sp @batch_ctrl_num, 
									@process_group_num,
								 @user_id,
 	 @cm_exist,
									@period_end,
 ...
 IF( @result != 0 )
 	...
 	IF ( @debug_level > 1 ) SELECT CONVERT(char,getdate(),109) + "  " + "tmp/apvapb2.sp" + ", line " + STR( 107, 5 ) + " -- EXIT: "
 RETURN @rf_result 
END
GO
GRANT EXECUTE ON  [dbo].[APVAPostBatch2_sp] TO [public]
GO
