...
CREATE PROCEDURE [dbo].[tdc_master_pack_stl_load_cartons_sp]
(
	@CARTON_NO	INT,
	@STLBIN_NO	VARCHAR(12)
)
...
BEGIN
	...
	BEGIN 
		UPDATE tdc_carton_tx 
		   SET stl_status = 'Y', stlbin_no = @STLBIN_NO 
...
END
GO
GRANT EXECUTE ON  [dbo].[tdc_master_pack_stl_load_cartons_sp] TO [public]
GO
