...
SET @one_for_one_flg = 'Y'  
 ...
 END  
 -- END v1.7  
 INSERT INTO #next_bin_group (id_bin, bin_group, qty, qty_available) VALUES (3, @pick_bin_group      , @ALLOC_QTY_FENCE_QTY, @qty_available)  
  
 -- < @ALLOC_QTY_FENCE_QTY  
-- SET @qty_available = 0 -- v1.3  
-- exec @qty_available = CVO_CheckAvailabilityInBinGroup_sp @part_no,@location,@pick_bin_group -- v1.3  
 INSERT INTO #next_bin_group (id_bin, bin_group, qty, qty_available) VALUES (4, @pick_bin_group   , @ALLOC_QTY_FENCE_QTY - 1, @qty_available)  
  
-- SET @qty_available = 0 -- v1.3  
-- exec @qty_available = CVO_CheckAvailabilityInBinGroup_sp @part_no,@location,@hight_bays_bin_group -- v1.3  
 INSERT INTO #next_bin_group (id_bin, bin_group, qty, qty_available) VALUES (5, @hight_bays_bin_group, @ALLOC_QTY_FENCE_QTY - 1, @high_bay_qty)  
  
-- SET @qty_available = 0 -- v1.3  
-- exec @qty_available = CVO_CheckAvailabilityInBinGroup_sp @part_no,@location,@bulk_bin_group -- v1.3  
 INSERT INTO #next_bin_group (id_bin, bin_group, qty, qty_available) VALUES (6, @bulk_bin_group      , @ALLOC_QTY_FENCE_QTY - 1, @bulk_qty)  
