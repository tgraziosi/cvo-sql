...
CREATE PROCEDURE [dbo].[adm_post_ap_cancel_tax] @err_msg varchar(255) OUT,
  @trx_ctrl_num varchar(16) = '' , @trx_type int = ''
AS 
set nocount on
----------------------------------------------------------------------------------------------------------------------------------------------
...
begin
    ...
    delete from #vouchers where trx_ctrl_num = @trx_ctrl_num
...
return @rc
GO
GRANT EXECUTE ON  [dbo].[adm_post_ap_cancel_tax] TO [public]
GO
