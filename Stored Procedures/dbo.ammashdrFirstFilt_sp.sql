...
CREATE PROCEDURE [dbo].[ammashdrFirstFilt_sp]
(
	@rowsrequested				smCounter = 1,
	@mass_description_filter 	smStdDescription
)
AS
...
FROM	ammashdr
WHERE	mass_description 		LIKE @mass_description_filter
...
FROM	ammashdr
WHERE	mass_maintenance_id 	> @MSKmass_maintenance_id
AND 	mass_description	 	LIKE @mass_description_filter
...
RETURN 0
GO
GRANT EXECUTE ON  [dbo].[ammashdrFirstFilt_sp] TO [public]
GO
