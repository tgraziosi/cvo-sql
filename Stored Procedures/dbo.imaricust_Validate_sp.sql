...
GO
    ...
    CREATE procedure 
[dbo].[imaricust_Validate_sp] @imaricust_Validate_sp_Batch_Number INT = 0,
                      @imaricust_Validate_sp_Starting_Record_Number INT = 0,
                      @imaricust_Validate_sp_Ending_Record_Number INT = 0,
                      @imaricust_Validate_sp_Dummy_1 INT = 0,
                      @debug_level INT = 0,
                      @imaricust_Validate_sp_Record_Type INT = 0,
                      @imaricust_Validate_sp_Import_Identifier INT = 0,
                      @userid INT = 0,
                      @imaricust_Validate_sp_Application_Name VARCHAR(30) = 'Import Manager',
                      @imaricust_Validate_sp_Override_User_Name VARCHAR(30) = ''
    AS
    ...
    SET @Routine_Name = 'imaricust_Validate_sp'        
    IF @debug_level >= 3
    ...
    IF @imaricust_Validate_sp_Import_Identifier = 0    
            OR @imaricust_Validate_sp_Import_Identifier IS NULL
        BEGIN        
        EXEC @SP_Result = imaricust_sp @company_code = @company_code,
                                       @address_type = @imaricust_Validate_sp_Record_Type,
                                       @trial_flag = 1,
                                       @debug_level = @debug_level,
                                       @userid = @userid,
                                       @imaricust_sp_process_ctrl_num = @process_ctrl_num OUTPUT,
                                       @imaricust_sp_dummy = @Dummy OUTPUT,
                                       @imaricust_sp_Import_Identifier = @imaricust_Validate_sp_Import_Identifier OUTPUT,
                                       @imaricust_sp_Override_User_Name = @imaricust_Validate_sp_Override_User_Name
    ...
    ELSE    
        ...
        EXEC @SP_Result = imaricust_sp @company_code = @company_code,
                                       ...
                                       @imaricust_sp_process_ctrl_num = @process_ctrl_num OUTPUT,
                                       @imaricust_sp_dummy = @Dummy OUTPUT,
                                       @imaricust_sp_Import_Identifier = @imaricust_Validate_sp_Import_Identifier,
                                       @imaricust_sp_Override_User_Name = @imaricust_Validate_sp_Override_User_Name
    ...
    SET @Import_Identifier = @imaricust_Validate_sp_Import_Identifier
    --
...
Error_Return:
    ...
    RETURN -1    
GO
GRANT EXECUTE ON  [dbo].[imaricust_Validate_sp] TO [public]
GO
