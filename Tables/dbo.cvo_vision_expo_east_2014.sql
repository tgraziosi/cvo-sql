CREATE TABLE [dbo].[cvo_vision_expo_east_2014]
(
...
GO
ALTER TABLE [dbo].[cvo_vision_expo_east_2014] ADD CONSTRAINT [PK__cvo_vision_expo___1825A2AF] PRIMARY KEY CLUSTERED  ([id]) ON [PRIMARY]
GO
