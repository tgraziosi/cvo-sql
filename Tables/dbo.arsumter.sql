...
GO
CREATE UNIQUE CLUSTERED INDEX [arsumter_ind_0] ON [dbo].[arsumter] ([territory_code], [date_thru]) ON [PRIMARY]
GO
GRANT REFERENCES ON  [dbo].[arsumter] TO [public]
GO
GRANT SELECT ON  [dbo].[arsumter] TO [public]
GO
GRANT INSERT ON  [dbo].[arsumter] TO [public]
GO
GRANT DELETE ON  [dbo].[arsumter] TO [public]
GO
GRANT UPDATE ON  [dbo].[arsumter] TO [public]
GO
