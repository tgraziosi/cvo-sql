...
GO
CREATE UNIQUE CLUSTERED INDEX [aractshp_ind_0] ON [dbo].[aractshp] ([customer_code], [ship_to_code]) ON [PRIMARY]
GO
GRANT REFERENCES ON  [dbo].[aractshp] TO [public]
GO
GRANT SELECT ON  [dbo].[aractshp] TO [public]
GO
GRANT INSERT ON  [dbo].[aractshp] TO [public]
GO
GRANT DELETE ON  [dbo].[aractshp] TO [public]
GO
GRANT UPDATE ON  [dbo].[aractshp] TO [public]
GO
