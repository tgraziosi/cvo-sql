CREATE TABLE [dbo].[rpt_ampostassetactdetacct]
(
[amount] [float] NULL,
...
GO
GRANT REFERENCES ON  [dbo].[rpt_ampostassetactdetacct] TO [public]
GO
GRANT SELECT ON  [dbo].[rpt_ampostassetactdetacct] TO [public]
GO
GRANT INSERT ON  [dbo].[rpt_ampostassetactdetacct] TO [public]
GO
GRANT DELETE ON  [dbo].[rpt_ampostassetactdetacct] TO [public]
GO
GRANT UPDATE ON  [dbo].[rpt_ampostassetactdetacct] TO [public]
GO
