CREATE TABLE [dbo].[tdc_arch_errdump]
(
...
GO
GRANT SELECT ON  [dbo].[tdc_arch_errdump] TO [public]
GO
GRANT INSERT ON  [dbo].[tdc_arch_errdump] TO [public]
GO
GRANT DELETE ON  [dbo].[tdc_arch_errdump] TO [public]
GO
GRANT UPDATE ON  [dbo].[tdc_arch_errdump] TO [public]
GO
