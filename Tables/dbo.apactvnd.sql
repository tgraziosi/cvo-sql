...
GO
CREATE UNIQUE CLUSTERED INDEX [apactvnd_ind_0] ON [dbo].[apactvnd] ([vendor_code]) ON [PRIMARY]
GO
GRANT REFERENCES ON  [dbo].[apactvnd] TO [public]
GO
GRANT SELECT ON  [dbo].[apactvnd] TO [public]
GO
GRANT INSERT ON  [dbo].[apactvnd] TO [public]
GO
GRANT DELETE ON  [dbo].[apactvnd] TO [public]
GO
GRANT UPDATE ON  [dbo].[apactvnd] TO [public]
GO
