CREATE TABLE [dbo].[rpt_ampostassetactdt]
(
[amount] [float] NULL,
...
[classification_code] [varchar] (8) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
...
GO
GRANT REFERENCES ON  [dbo].[rpt_ampostassetactdt] TO [public]
GO
GRANT SELECT ON  [dbo].[rpt_ampostassetactdt] TO [public]
GO
GRANT INSERT ON  [dbo].[rpt_ampostassetactdt] TO [public]
GO
GRANT DELETE ON  [dbo].[rpt_ampostassetactdt] TO [public]
GO
GRANT UPDATE ON  [dbo].[rpt_ampostassetactdt] TO [public]
GO
