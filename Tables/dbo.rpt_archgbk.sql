...
GO
GRANT REFERENCES ON  [dbo].[rpt_archgbk] TO [public]
GO
GRANT SELECT ON  [dbo].[rpt_archgbk] TO [public]
GO
GRANT INSERT ON  [dbo].[rpt_archgbk] TO [public]
GO
GRANT DELETE ON  [dbo].[rpt_archgbk] TO [public]
GO
GRANT UPDATE ON  [dbo].[rpt_archgbk] TO [public]
GO
