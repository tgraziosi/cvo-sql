CREATE TABLE [dbo].[tdc_inbound_ASN_err]
(
...
[qty_transmitted] [decimal] (20, 8) NULL,
...
GO
CREATE NONCLUSTERED INDEX [tdc_inbound_ASN_err_indx1] ON [dbo].[tdc_inbound_ASN_err] ([ASN], [SSCC], [carton_no], [po_no], [part_no], [lot_ser]) ON [PRIMARY]
GO
GRANT SELECT ON  [dbo].[tdc_inbound_ASN_err] TO [public]
GO
GRANT INSERT ON  [dbo].[tdc_inbound_ASN_err] TO [public]
GO
GRANT DELETE ON  [dbo].[tdc_inbound_ASN_err] TO [public]
GO
GRANT UPDATE ON  [dbo].[tdc_inbound_ASN_err] TO [public]
GO
