...
GO
CREATE UNIQUE CLUSTERED INDEX [aractslp_ind_0] ON [dbo].[aractslp] ([salesperson_code]) ON [PRIMARY]
GO
GRANT REFERENCES ON  [dbo].[aractslp] TO [public]
GO
GRANT SELECT ON  [dbo].[aractslp] TO [public]
GO
GRANT INSERT ON  [dbo].[aractslp] TO [public]
GO
GRANT DELETE ON  [dbo].[aractslp] TO [public]
GO
GRANT UPDATE ON  [dbo].[aractslp] TO [public]
GO
