CREATE TABLE [dbo].[rpt_arpinv_age]
(
...
GO
GRANT REFERENCES ON  [dbo].[rpt_arpinv_age] TO [public]
GO
GRANT SELECT ON  [dbo].[rpt_arpinv_age] TO [public]
GO
GRANT INSERT ON  [dbo].[rpt_arpinv_age] TO [public]
GO
GRANT DELETE ON  [dbo].[rpt_arpinv_age] TO [public]
GO
GRANT UPDATE ON  [dbo].[rpt_arpinv_age] TO [public]
GO
