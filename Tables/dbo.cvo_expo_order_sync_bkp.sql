CREATE TABLE [dbo].[cvo_expo_order_sync_bkp]
(
...
GO
ALTER TABLE [dbo].[cvo_expo_order_sync_bkp] ADD CONSTRAINT [PK__cvo_expo_order_s__2B1ADD97] PRIMARY KEY CLUSTERED  ([id]) ON [PRIMARY]
GO
