...
GO
CREATE UNIQUE CLUSTERED INDEX [apactbch_ind_0] ON [dbo].[apactbch] ([branch_code]) ON [PRIMARY]
GO
GRANT REFERENCES ON  [dbo].[apactbch] TO [public]
GO
GRANT SELECT ON  [dbo].[apactbch] TO [public]
GO
GRANT INSERT ON  [dbo].[apactbch] TO [public]
GO
GRANT DELETE ON  [dbo].[apactbch] TO [public]
GO
GRANT UPDATE ON  [dbo].[apactbch] TO [public]
GO
