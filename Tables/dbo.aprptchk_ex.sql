...
[extra_copy] [smallint] NOT NULL
) ON [PRIMARY]
GO
GRANT REFERENCES ON  [dbo].[aprptchk_ex] TO [public]
GO
GRANT SELECT ON  [dbo].[aprptchk_ex] TO [public]
GO
GRANT INSERT ON  [dbo].[aprptchk_ex] TO [public]
GO
GRANT DELETE ON  [dbo].[aprptchk_ex] TO [public]
GO
GRANT UPDATE ON  [dbo].[aprptchk_ex] TO [public]
GO
