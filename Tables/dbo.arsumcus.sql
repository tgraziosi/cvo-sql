...
GO
CREATE UNIQUE CLUSTERED INDEX [arsumcus_ind_0] ON [dbo].[arsumcus] ([customer_code], [date_thru]) ON [PRIMARY]
GO
GRANT REFERENCES ON  [dbo].[arsumcus] TO [public]
GO
GRANT SELECT ON  [dbo].[arsumcus] TO [public]
GO
GRANT INSERT ON  [dbo].[arsumcus] TO [public]
GO
GRANT DELETE ON  [dbo].[arsumcus] TO [public]
GO
GRANT UPDATE ON  [dbo].[arsumcus] TO [public]
GO
