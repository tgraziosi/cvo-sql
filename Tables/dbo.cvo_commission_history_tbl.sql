CREATE TABLE [dbo].[cvo_commission_history_tbl]
(
...
GO
CREATE CLUSTERED INDEX [pk_commis_hist_tbl] ON [dbo].[cvo_commission_history_tbl] ([salesperson], [territory], [report_month]) ON [PRIMARY]
GO
GRANT REFERENCES ON  [dbo].[cvo_commission_history_tbl] TO [public]
GO
GRANT SELECT ON  [dbo].[cvo_commission_history_tbl] TO [public]
GO
GRANT INSERT ON  [dbo].[cvo_commission_history_tbl] TO [public]
GO
GRANT DELETE ON  [dbo].[cvo_commission_history_tbl] TO [public]
GO
GRANT UPDATE ON  [dbo].[cvo_commission_history_tbl] TO [public]
GO
