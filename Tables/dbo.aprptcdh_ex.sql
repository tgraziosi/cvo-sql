...
GO
GRANT REFERENCES ON  [dbo].[aprptcdh_ex] TO [public]
GO
GRANT SELECT ON  [dbo].[aprptcdh_ex] TO [public]
GO
GRANT INSERT ON  [dbo].[aprptcdh_ex] TO [public]
GO
GRANT DELETE ON  [dbo].[aprptcdh_ex] TO [public]
GO
GRANT UPDATE ON  [dbo].[aprptcdh_ex] TO [public]
GO
