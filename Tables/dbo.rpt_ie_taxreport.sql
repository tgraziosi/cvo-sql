CREATE TABLE [dbo].[rpt_ie_taxreport]
(
[org_id] [varchar] (30) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[recipient_org_id] [varchar] (30) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[source_trx_ctrl_num] [varchar] (32) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
GRANT REFERENCES ON  [dbo].[rpt_ie_taxreport] TO [public]
GO
GRANT SELECT ON  [dbo].[rpt_ie_taxreport] TO [public]
GO
GRANT INSERT ON  [dbo].[rpt_ie_taxreport] TO [public]
GO
GRANT DELETE ON  [dbo].[rpt_ie_taxreport] TO [public]
GO
GRANT UPDATE ON  [dbo].[rpt_ie_taxreport] TO [public]
GO
