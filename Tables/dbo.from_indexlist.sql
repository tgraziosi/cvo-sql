CREATE TABLE [dbo].[from_indexlist]
(
...
GO
GRANT SELECT ON  [dbo].[from_indexlist] TO [public]
GO
GRANT INSERT ON  [dbo].[from_indexlist] TO [public]
GO
GRANT DELETE ON  [dbo].[from_indexlist] TO [public]
GO
GRANT UPDATE ON  [dbo].[from_indexlist] TO [public]
GO
