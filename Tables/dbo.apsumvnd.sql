...
GO
CREATE UNIQUE CLUSTERED INDEX [apsumvnd_ind_0] ON [dbo].[apsumvnd] ([vendor_code], [date_thru]) ON [PRIMARY]
GO
GRANT REFERENCES ON  [dbo].[apsumvnd] TO [public]
GO
GRANT SELECT ON  [dbo].[apsumvnd] TO [public]
GO
GRANT INSERT ON  [dbo].[apsumvnd] TO [public]
GO
GRANT DELETE ON  [dbo].[apsumvnd] TO [public]
GO
GRANT UPDATE ON  [dbo].[apsumvnd] TO [public]
GO
