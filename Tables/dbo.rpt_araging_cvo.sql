CREATE TABLE [dbo].[rpt_araging_cvo]
(
...
GO
GRANT REFERENCES ON  [dbo].[rpt_araging_cvo] TO [public]
GO
GRANT SELECT ON  [dbo].[rpt_araging_cvo] TO [public]
GO
GRANT INSERT ON  [dbo].[rpt_araging_cvo] TO [public]
GO
GRANT DELETE ON  [dbo].[rpt_araging_cvo] TO [public]
GO
GRANT UPDATE ON  [dbo].[rpt_araging_cvo] TO [public]
GO
