...
[process_status] [varchar] (80) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
...
GO
GRANT REFERENCES ON  [dbo].[rpt_appsterr] TO [public]
GO
GRANT SELECT ON  [dbo].[rpt_appsterr] TO [public]
GO
GRANT INSERT ON  [dbo].[rpt_appsterr] TO [public]
GO
GRANT DELETE ON  [dbo].[rpt_appsterr] TO [public]
GO
GRANT UPDATE ON  [dbo].[rpt_appsterr] TO [public]
GO
