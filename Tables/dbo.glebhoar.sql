...
[to_date] [int] NULL,
[date_archived] [int] NULL
) ON [PRIMARY]
GO
GRANT REFERENCES ON  [dbo].[glebhoar] TO [public]
GO
GRANT SELECT ON  [dbo].[glebhoar] TO [public]
GO
GRANT INSERT ON  [dbo].[glebhoar] TO [public]
GO
GRANT DELETE ON  [dbo].[glebhoar] TO [public]
GO
GRANT UPDATE ON  [dbo].[glebhoar] TO [public]
GO
