...
GO
CREATE UNIQUE CLUSTERED INDEX [apsumpto_ind_0] ON [dbo].[apsumpto] ([vendor_code], [pay_to_code], [date_thru]) ON [PRIMARY]
GO
GRANT REFERENCES ON  [dbo].[apsumpto] TO [public]
GO
GRANT SELECT ON  [dbo].[apsumpto] TO [public]
GO
GRANT INSERT ON  [dbo].[apsumpto] TO [public]
GO
GRANT DELETE ON  [dbo].[apsumpto] TO [public]
GO
GRANT UPDATE ON  [dbo].[apsumpto] TO [public]
GO
