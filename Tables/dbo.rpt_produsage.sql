CREATE TABLE [dbo].[rpt_produsage]
(
[prod_no] [int] NULL,
[prod_ext] [int] NULL,
...
GO
GRANT REFERENCES ON  [dbo].[rpt_produsage] TO [public]
GO
GRANT SELECT ON  [dbo].[rpt_produsage] TO [public]
GO
GRANT INSERT ON  [dbo].[rpt_produsage] TO [public]
GO
GRANT DELETE ON  [dbo].[rpt_produsage] TO [public]
GO
GRANT UPDATE ON  [dbo].[rpt_produsage] TO [public]
GO
