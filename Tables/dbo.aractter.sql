...
GO
CREATE UNIQUE CLUSTERED INDEX [aractter_ind_0] ON [dbo].[aractter] ([territory_code]) ON [PRIMARY]
GO
GRANT REFERENCES ON  [dbo].[aractter] TO [public]
GO
GRANT SELECT ON  [dbo].[aractter] TO [public]
GO
GRANT INSERT ON  [dbo].[aractter] TO [public]
GO
GRANT DELETE ON  [dbo].[aractter] TO [public]
GO
GRANT UPDATE ON  [dbo].[aractter] TO [public]
GO
