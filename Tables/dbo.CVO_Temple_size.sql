CREATE TABLE [dbo].[CVO_Temple_size]
(
...
GO
GRANT SELECT ON  [dbo].[CVO_Temple_size] TO [public]
GO
GRANT INSERT ON  [dbo].[CVO_Temple_size] TO [public]
GO
GRANT DELETE ON  [dbo].[CVO_Temple_size] TO [public]
GO
GRANT UPDATE ON  [dbo].[CVO_Temple_size] TO [public]
GO
