...
GO
CREATE UNIQUE CLUSTERED INDEX [apactcls_ind_0] ON [dbo].[apactcls] ([class_code]) ON [PRIMARY]
GO
GRANT REFERENCES ON  [dbo].[apactcls] TO [public]
GO
GRANT SELECT ON  [dbo].[apactcls] TO [public]
GO
GRANT INSERT ON  [dbo].[apactcls] TO [public]
GO
GRANT DELETE ON  [dbo].[apactcls] TO [public]
GO
GRANT UPDATE ON  [dbo].[apactcls] TO [public]
GO
