...
GO
GRANT REFERENCES ON  [dbo].[prrptmad] TO [public]
GO
GRANT SELECT ON  [dbo].[prrptmad] TO [public]
GO
GRANT INSERT ON  [dbo].[prrptmad] TO [public]
GO
GRANT DELETE ON  [dbo].[prrptmad] TO [public]
GO
GRANT UPDATE ON  [dbo].[prrptmad] TO [public]
GO
