...
GO
CREATE UNIQUE CLUSTERED INDEX [aractcus_ind_0] ON [dbo].[aractcus] ([customer_code]) ON [PRIMARY]
GO
GRANT REFERENCES ON  [dbo].[aractcus] TO [public]
GO
GRANT SELECT ON  [dbo].[aractcus] TO [public]
GO
GRANT INSERT ON  [dbo].[aractcus] TO [public]
GO
GRANT DELETE ON  [dbo].[aractcus] TO [public]
GO
GRANT UPDATE ON  [dbo].[aractcus] TO [public]
GO
