...
[symbol_inv] [varchar] (8) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[symbol_cm] [varchar] (8) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[symbol_adj] [varchar] (8) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[symbol_woff] [varchar] (8) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[symbol_pyt] [varchar] (8) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[symbol_nsf] [varchar] (8) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[symbol_fchg] [varchar] (8) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[symbol_lchg] [varchar] (8) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
) ON [PRIMARY]
GO
GRANT REFERENCES ON  [dbo].[rpt_aractprc] TO [public]
GO
GRANT SELECT ON  [dbo].[rpt_aractprc] TO [public]
GO
GRANT INSERT ON  [dbo].[rpt_aractprc] TO [public]
GO
GRANT DELETE ON  [dbo].[rpt_aractprc] TO [public]
GO
GRANT UPDATE ON  [dbo].[rpt_aractprc] TO [public]
GO
