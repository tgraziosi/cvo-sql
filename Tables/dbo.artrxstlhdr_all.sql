CREATE TABLE [dbo].[artrxstlhdr_all]
(
...
GO
CREATE NONCLUSTERED INDEX [artrxstlhdr_all_ind_0] ON [dbo].[artrxstlhdr_all] ([settlement_ctrl_num]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [artrxstlhdr_all_ind_1] ON [dbo].[artrxstlhdr_all] ([settlement_ctrl_num], [customer_code]) ON [PRIMARY]
GO
GRANT SELECT ON  [dbo].[artrxstlhdr_all] TO [public]
GO
GRANT INSERT ON  [dbo].[artrxstlhdr_all] TO [public]
GO
GRANT DELETE ON  [dbo].[artrxstlhdr_all] TO [public]
GO
GRANT UPDATE ON  [dbo].[artrxstlhdr_all] TO [public]
GO
