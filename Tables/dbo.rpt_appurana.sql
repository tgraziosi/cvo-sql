...
[gl_exp_acct] [varchar] (40) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[calc_tax] [float] NOT NULL
) ON [PRIMARY]
GO
GRANT REFERENCES ON  [dbo].[rpt_appurana] TO [public]
GO
GRANT SELECT ON  [dbo].[rpt_appurana] TO [public]
GO
GRANT INSERT ON  [dbo].[rpt_appurana] TO [public]
GO
GRANT DELETE ON  [dbo].[rpt_appurana] TO [public]
GO
GRANT UPDATE ON  [dbo].[rpt_appurana] TO [public]
GO
