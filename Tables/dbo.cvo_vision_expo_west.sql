CREATE TABLE [dbo].[cvo_vision_expo_west]
(
...
GO
ALTER TABLE [dbo].[cvo_vision_expo_west] ADD CONSTRAINT [PK__cvo_vision_expo___2D73634B] PRIMARY KEY CLUSTERED  ([id]) ON [PRIMARY]
GO
