...
GO
CREATE UNIQUE CLUSTERED INDEX [artrxndet_ind_0] ON [dbo].[artrxndet] ([trx_ctrl_num], [trx_type], [sequence_id]) ON [PRIMARY]
GO
GRANT REFERENCES ON  [dbo].[artrxndet] TO [public]
GO
GRANT SELECT ON  [dbo].[artrxndet] TO [public]
GO
GRANT INSERT ON  [dbo].[artrxndet] TO [public]
GO
GRANT DELETE ON  [dbo].[artrxndet] TO [public]
GO
GRANT UPDATE ON  [dbo].[artrxndet] TO [public]
GO
