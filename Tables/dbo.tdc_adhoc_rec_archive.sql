CREATE TABLE [dbo].[tdc_adhoc_rec_archive]
(
...
GO
GRANT SELECT ON  [dbo].[tdc_adhoc_rec_archive] TO [public]
GO
GRANT INSERT ON  [dbo].[tdc_adhoc_rec_archive] TO [public]
GO
GRANT DELETE ON  [dbo].[tdc_adhoc_rec_archive] TO [public]
GO
GRANT UPDATE ON  [dbo].[tdc_adhoc_rec_archive] TO [public]
GO
