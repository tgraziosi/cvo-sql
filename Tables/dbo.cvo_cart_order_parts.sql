...
[pick_source] [varchar] (2) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[pair_bin] [varchar] (6) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[print_flag] [tinyint] NULL CONSTRAINT [DF__cvo_cart___print__5F9BF4D3] DEFAULT ((0))
) ON [PRIMARY]
GO
