...
[affiliated_vend_code] [varchar] (12) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[alt_vendor_code] [varchar] (12) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
...
[aging_limit] [varchar] (20) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
...
[lead_time] [varchar] (20) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
...
GO
GRANT REFERENCES ON  [dbo].[rpt_apvend] TO [public]
GO
GRANT SELECT ON  [dbo].[rpt_apvend] TO [public]
GO
GRANT INSERT ON  [dbo].[rpt_apvend] TO [public]
GO
GRANT DELETE ON  [dbo].[rpt_apvend] TO [public]
GO
GRANT UPDATE ON  [dbo].[rpt_apvend] TO [public]
GO
