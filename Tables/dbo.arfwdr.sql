...
GO
CREATE UNIQUE CLUSTERED INDEX [fwd1] ON [dbo].[arfwdr] ([kys]) ON [PRIMARY]
GO
GRANT REFERENCES ON  [dbo].[arfwdr] TO [public]
GO
GRANT SELECT ON  [dbo].[arfwdr] TO [public]
GO
GRANT INSERT ON  [dbo].[arfwdr] TO [public]
GO
GRANT DELETE ON  [dbo].[arfwdr] TO [public]
GO
GRANT UPDATE ON  [dbo].[arfwdr] TO [public]
GO
