CREATE TABLE [dbo].[esc_vendor_sku]
(
...
GO
GRANT SELECT ON  [dbo].[esc_vendor_sku] TO [public]
GO
GRANT INSERT ON  [dbo].[esc_vendor_sku] TO [public]
GO
GRANT DELETE ON  [dbo].[esc_vendor_sku] TO [public]
GO
GRANT UPDATE ON  [dbo].[esc_vendor_sku] TO [public]
GO
