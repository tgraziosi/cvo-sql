...
GO
GRANT REFERENCES ON  [dbo].[apinptaxdtl] TO [public]
GO
GRANT SELECT ON  [dbo].[apinptaxdtl] TO [public]
GO
GRANT INSERT ON  [dbo].[apinptaxdtl] TO [public]
GO
GRANT DELETE ON  [dbo].[apinptaxdtl] TO [public]
GO
GRANT UPDATE ON  [dbo].[apinptaxdtl] TO [public]
GO
