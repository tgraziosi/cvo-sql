CREATE TABLE [dbo].[app_indexlist]
(
...
GO
GRANT SELECT ON  [dbo].[app_indexlist] TO [public]
GO
GRANT INSERT ON  [dbo].[app_indexlist] TO [public]
GO
GRANT DELETE ON  [dbo].[app_indexlist] TO [public]
GO
GRANT UPDATE ON  [dbo].[app_indexlist] TO [public]
GO
