CREATE TABLE [dbo].[cvo_vision_expo_config]
(
...
GO
ALTER TABLE [dbo].[cvo_vision_expo_config] ADD CONSTRAINT [PK__cvo_vision_expo___20BF7AF0] PRIMARY KEY CLUSTERED  ([id]) ON [PRIMARY]
GO
