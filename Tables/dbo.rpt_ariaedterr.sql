CREATE TABLE [dbo].[rpt_ariaedterr]
(
[info2] [char] (16) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
...
GO
GRANT REFERENCES ON  [dbo].[rpt_ariaedterr] TO [public]
GO
GRANT SELECT ON  [dbo].[rpt_ariaedterr] TO [public]
GO
GRANT INSERT ON  [dbo].[rpt_ariaedterr] TO [public]
GO
GRANT DELETE ON  [dbo].[rpt_ariaedterr] TO [public]
GO
GRANT UPDATE ON  [dbo].[rpt_ariaedterr] TO [public]
GO
