...
GO
GRANT REFERENCES ON  [dbo].[glebhold] TO [public]
GO
GRANT SELECT ON  [dbo].[glebhold] TO [public]
GO
GRANT INSERT ON  [dbo].[glebhold] TO [public]
GO
GRANT DELETE ON  [dbo].[glebhold] TO [public]
GO
GRANT UPDATE ON  [dbo].[glebhold] TO [public]
GO
