CREATE TABLE [dbo].[cvo_expo_order_lines]
(
...
GO
ALTER TABLE [dbo].[cvo_expo_order_lines] ADD CONSTRAINT [PK__cvo_expo_order_l__20484969] PRIMARY KEY CLUSTERED  ([id]) ON [PRIMARY]
GO
