...
GO
CREATE UNIQUE CLUSTERED INDEX [apsumbch_ind_0] ON [dbo].[apsumbch] ([branch_code], [date_thru]) ON [PRIMARY]
GO
GRANT REFERENCES ON  [dbo].[apsumbch] TO [public]
GO
GRANT SELECT ON  [dbo].[apsumbch] TO [public]
GO
GRANT INSERT ON  [dbo].[apsumbch] TO [public]
GO
GRANT DELETE ON  [dbo].[apsumbch] TO [public]
GO
GRANT UPDATE ON  [dbo].[apsumbch] TO [public]
GO
