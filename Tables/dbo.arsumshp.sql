...
GO
CREATE UNIQUE CLUSTERED INDEX [arsumshp_ind_0] ON [dbo].[arsumshp] ([customer_code], [ship_to_code], [date_thru]) ON [PRIMARY]
GO
GRANT REFERENCES ON  [dbo].[arsumshp] TO [public]
GO
GRANT SELECT ON  [dbo].[arsumshp] TO [public]
GO
GRANT INSERT ON  [dbo].[arsumshp] TO [public]
GO
GRANT DELETE ON  [dbo].[arsumshp] TO [public]
GO
GRANT UPDATE ON  [dbo].[arsumshp] TO [public]
GO
