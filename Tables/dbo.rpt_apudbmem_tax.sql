CREATE TABLE [dbo].[rpt_apudbmem_tax]
(
...
GO
GRANT REFERENCES ON  [dbo].[rpt_apudbmem_tax] TO [public]
GO
GRANT SELECT ON  [dbo].[rpt_apudbmem_tax] TO [public]
GO
GRANT INSERT ON  [dbo].[rpt_apudbmem_tax] TO [public]
GO
GRANT DELETE ON  [dbo].[rpt_apudbmem_tax] TO [public]
GO
GRANT UPDATE ON  [dbo].[rpt_apudbmem_tax] TO [public]
GO
