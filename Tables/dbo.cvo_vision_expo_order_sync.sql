CREATE TABLE [dbo].[cvo_vision_expo_order_sync]
(
...
GO
ALTER TABLE [dbo].[cvo_vision_expo_order_sync] ADD CONSTRAINT [PK__cvo_vision_expo___333330E6] PRIMARY KEY CLUSTERED  ([id]) ON [PRIMARY]
GO
