...
GO
GRANT REFERENCES ON  [dbo].[pr_customers] TO [public]
GO
GRANT SELECT ON  [dbo].[pr_customers] TO [public]
GO
GRANT INSERT ON  [dbo].[pr_customers] TO [public]
GO
GRANT DELETE ON  [dbo].[pr_customers] TO [public]
GO
GRANT UPDATE ON  [dbo].[pr_customers] TO [public]
GO
