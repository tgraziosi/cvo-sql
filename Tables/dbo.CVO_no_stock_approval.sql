CREATE TABLE [dbo].[CVO_no_stock_approval]
(
...
GO
GRANT DELETE ON  [dbo].[CVO_no_stock_approval] TO [public]
GO
GRANT INSERT ON  [dbo].[CVO_no_stock_approval] TO [public]
GO
GRANT REFERENCES ON  [dbo].[CVO_no_stock_approval] TO [public]
GO
GRANT SELECT ON  [dbo].[CVO_no_stock_approval] TO [public]
GO
GRANT UPDATE ON  [dbo].[CVO_no_stock_approval] TO [public]
GO
