CREATE TABLE [dbo].[rpt_ammassmtdt]
(
...
[field_type] [char] (16) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[new_value] [varchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[user_name] [varchar] (30) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
) ON [PRIMARY]
GO
GRANT REFERENCES ON  [dbo].[rpt_ammassmtdt] TO [public]
GO
GRANT SELECT ON  [dbo].[rpt_ammassmtdt] TO [public]
GO
GRANT INSERT ON  [dbo].[rpt_ammassmtdt] TO [public]
GO
GRANT DELETE ON  [dbo].[rpt_ammassmtdt] TO [public]
GO
GRANT UPDATE ON  [dbo].[rpt_ammassmtdt] TO [public]
GO
