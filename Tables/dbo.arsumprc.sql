...
GO
CREATE UNIQUE CLUSTERED INDEX [arsumprc_ind_0] ON [dbo].[arsumprc] ([price_code], [date_thru]) ON [PRIMARY]
GO
GRANT REFERENCES ON  [dbo].[arsumprc] TO [public]
GO
GRANT SELECT ON  [dbo].[arsumprc] TO [public]
GO
GRANT INSERT ON  [dbo].[arsumprc] TO [public]
GO
GRANT DELETE ON  [dbo].[arsumprc] TO [public]
GO
GRANT UPDATE ON  [dbo].[arsumprc] TO [public]
GO
