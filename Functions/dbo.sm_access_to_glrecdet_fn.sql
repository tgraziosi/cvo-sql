...
CREATE FUNCTION [dbo].[sm_access_to_glrecdet_fn] (@journal_ctrl_num varchar(16))
RETURNS smallint
BEGIN		
...
END
GO
GRANT REFERENCES ON  [dbo].[sm_access_to_glrecdet_fn] TO [public]
GO
GRANT EXECUTE ON  [dbo].[sm_access_to_glrecdet_fn] TO [public]
GO
