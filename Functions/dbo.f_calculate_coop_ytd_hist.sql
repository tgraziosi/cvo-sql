...
-- 
SELECT dbo.f_calculate_coop_ytd ('010581',0,0) 
SELECT dbo.f_calculate_coop_ytd ('012709',0,0) 
SELECT dbo.f_calculate_coop_ytd ('020294',0,0) 
SELECT dbo.f_calculate_coop_ytd ('024092',0,0) 
SELECT dbo.f_calculate_coop_ytd ('043337',0,0) 

*/

CREATE FUNCTION [dbo].[f_calculate_coop_ytd_hist] (@customer_code VARCHAR(8),@order_no INT, @ext INT) 
